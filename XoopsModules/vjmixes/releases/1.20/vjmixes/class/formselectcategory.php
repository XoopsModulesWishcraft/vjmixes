 ...
 * @access 		public 
 */
class VjmixesFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function VjmixesFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false)
    {
    ...
    {
		$vidcatHandler =& xoops_getmodulehandler('video_category', 'vjmixes');
